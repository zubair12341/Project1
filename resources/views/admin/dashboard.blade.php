...
@section('title', 'Wisdom Chest || Admin Dashboard')
                            ...
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h3 class="counter without-icon color-primary"><span class="odometer"
                                            data-count="{{ $book_count }}">{{ $book_count }}</span>
                                    </h3>
                            ...
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h3 class="counter without-icon color-pink"><span class="odometer"
                                            data-count="{{ $user_count }}">{{ $user_count }}</span>
                                    </h3>
                ...
                <div class="row gy-5">
                    <div class="col-lg-12">
                        ...
                        <div class="load-more-btn text-center">
                            <a class="rbt-btn-link" href="{{ route('admin.books') }}">Browse All Books<i class="feather-arrow-right"></i></a>
                        </div>
                    </div>
                </div>

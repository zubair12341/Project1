...
<link
    ...
    rel="stylesheet"
/>
@section('title', 'Wisdom Chest || Admin Create Online Course')
                                        ...
                                        <div class="accordion-body card-body">
                                            ...
                                            <div class="rbt-course-field-wrapper rbt-default-form">
                                                ...
                                                <div class="course-field mb--15">
                                                    ...
                                                    <input id="teacher" name="teacher" class="form-control  @error('teacher') is-invalid @enderror" type="text"
                                                ...
                                                <div class="course-field mb--15">
                                                    ...
                                                    <div class="rbt-modern-select bg-transparent height-45 mb--10">
                                                        <select class="w-100" class="form-control  @error('age_range') is-invalid @enderror" id="age_range" name="age_range">
                                                            <option value="All Ages">All Ages</option>
                                                            <option value="6 - 8">6 - 8</option>
                                                            <option value="9 - 11">9 - 11</option>
                                                            <option value="12 - 14">12 - 14</option>
                                                            <option value="15 years old and above">15 years old and above</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="course-field mb--20">
                                                    ...
                                                    <input type="file" id="test" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="cover_image" >
                                                ...
                                                <div class="course-field mb--20">
                                                    <h6>Course Other Images</h6>
                                                    <input type="file" id="test2" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="other_img1" >

                                                    <small><i class="feather-info"></i> <b>Size:</b> 700x430 pixels,
                                                        <b>File
                                                            Support:</b> JPG, JPEG, PNG, GIF, WEBP</small>
                                                    <br>
                                                    <input type="file" id="test3" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="other_img2" >
                                                ...
                                                <div class="course-field mb--20">
                                                    <h6>Course Videos (Upload 3 videos)</h6>

                                                    <input type="file" id="vid1" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="video1" ><br>
                                                    <input type="file" id="vid2" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="video2" ><br>
                                                    <input type="file" id="vid3" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="video3" >
                                        ...
                                        <div
                                            ...
                                            <div id="quiz-container">
                                                ...
                                                <div class="course-field mb--15">
                                                    ...
                                                    <input id="price" name="price" class="form-control  @error('price') is-invalid @enderror" type="number"
                                                ...
                                                <div class="rbt-modern-select bg-transparent height-45 w-100 mb--10">
                                                    <select class="w-100" data-live-search="true" id="status"
                                                        name="status"
                                                        title="Search Online Course Category. ex. Design, Development, Business"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        pond.setOptions({
            server: {
                process: '/tmp-cover-upload',
                revert: '/tmp-cover-delete', //zubair
                headers: {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        pond.setOptions({
            server: {
                process: '/tmp-cover-upload2',
                revert: '/tmp-cover-delete2', //zubair
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        pond.setOptions({
            server: {
                process: '/tmp-cover-upload3',
                revert: '/tmp-cover-delete3', //zubair
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        FilePond.registerPlugin(FilePondPluginImagePreview);
        const inputElement = document.getElementById('vid1');
        ...
        pond.setOptions({
            server: {
                process: '/tmp-vid-upload',
                revert: '/tmp-vid-delete', //zubair
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        FilePond.registerPlugin(FilePondPluginImagePreview);
        const inputElement = document.getElementById('vid2');
        ...
        pond.setOptions({
            server: {
                process: '/tmp-vid-upload2',
                revert: '/tmp-vid-delete2', //zubair
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        FilePond.registerPlugin(FilePondPluginImagePreview);
        const inputElement = document.getElementById('vid3');
        ...
        pond.setOptions({
            server: {
                process: '/tmp-vid-upload3',
                revert: '/tmp-vid-delete3', //zubair
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },

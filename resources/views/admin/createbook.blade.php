...
@section('title', 'Wisdom Chest || Admin Create Book')
<script>
...
@section('content')
    ...
    <div class="loader-container" id="loader" style="display: none;">
        ...
        <label class="loading-text">Saving book...</label>
    </div>
    <!-- Mobile Menu Section -->
    ...
    <main class="rbt-main-wrapper">
        <form id="bookForm" action="{{ route('admin.storebook') }}" method="post" enctype="multipart/form-data">
            @csrf
                                                ...
                                                <div class="rbt-course-field-wrapper rbt-default-form">
                                                    ...
                                                    <div class="course-field mb--20">
                                                        ...
                                                        <div
                                                            ...
                                                            <select
                                                                ...
                                                                title="Search Book Genre. ex. Suspense, Thriler, Drama"
                                                                multiple
                                                                data-size="7"
                                                    ...
                                                    <script>
                                                        document.addEventListener('DOMContentLoaded', function () {
                                                            var selectElement = document.getElementById('book-genre-select');

                                                            selectElement.addEventListener('change', function (event) {
                                                                var selectedGenres = Array.from(selectElement.selectedOptions).map(function (option) {
                                                                    return option.text;
                                                                });

                                                                if (selectedGenres.length > 2) {
                                                                    // If more than 2 genres are selected, customize the text
                                                                    selectElement.options[0].textContent = selectedGenres.length + ' Genres selected';
                                                                } else if (selectedGenres.length > 0) {
                                                                    selectElement.options[0].textContent = selectedGenres.join(', ');
                                                                } else {
                                                                    selectElement.options[0].textContent = 'Choose Genre';
                                                                }
                                                            });
                                                        });
                                                        </script>
                                                    ...
                                                    <div class="course-field mb--15">
                                                        <div class="course-field mb--15">
                                                            <label for="startDate">Publishing Date</label>
                                                            <input
                                                    ...
                                                    <div class="course-field mb--20">
                                                        <h6>Book Cover Image</h6>
                                                                <input type="file" id="test" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="book_cover_image" >
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                pond.setOptions({
                    server: {
                        process: '/tmp-upload',
                        revert: '/tmp-delete', //zubair
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                        },
                    },
                    allowFileSize: true,  // Enable file size validation
                    maxFileSize: 5242880,   // Set the maximum allowed file size (5MB in bytes)
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        FilePond.registerPlugin(FilePondPluginImagePreview);
        const inputElement = document.getElementById('book_intro_video');
        ...
        pond.setOptions({
            server: {
                process: '/tmp-upload-intro',
                revert: '/tmp-delete-intro', //
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        pond.setOptions({
            server: {
                process: '/tmp-upload-vide',
                revert: '/tmp-delete-vide', //
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        pond.setOptions({
            server: {
                process: '/tmp-upload-videm',
                revert: '/tmp-delete-videm', //
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        FilePond.registerPlugin(FilePondPluginImagePreview);
        const inputElement = document.getElementById('document_files');
        ...
        pond.setOptions({
            server: {
                process: '/tmp-upload-mdoc',
                revert: '/tmp-delete-mdoc', //
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        FilePond.registerPlugin(FilePondPluginImagePreview);
        const inputElement = document.getElementById('vocab_files');
        ...
        pond.setOptions({
            server: {
                process: '/tmp-upload-mvoc',
                revert: '/tmp-delete-mvoc', //
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        FilePond.registerPlugin(FilePondPluginImagePreview);
        const inputElement = document.getElementById('document_file');
        ...
        pond.setOptions({
            server: {
                process: '/tmp-upload-doc',
                revert: '/tmp-delete-doc', //
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        FilePond.registerPlugin(FilePondPluginImagePreview);
        const inputElement = document.getElementById('vocab_file');
        ...
        pond.setOptions({
            server: {
                process: '/tmp-upload-voc',
                revert: '/tmp-delete-voc',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },
            },
                                        ...
                                        <div id="accCollapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div
                                                ...
                                                <div class="course-field mb--15">
                                                    ...
                                                    <input type="file" id="book_intro_video" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="book_intro_video" >

                                                    <br><br>
                                                    <div>
                                                        <label for="videoUrl">Add Book Video <b style="color: red">*</b></label>
                                                    </div>
                                                    <div id="container">
                                                        ...
                                                        <div class="field">
                                                            ...
                                                            <input type="file" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="video" id="video">
                                                            {{-- <p class="file-info">File size is max 100</p> --}}
                                                        </div>
                                                    </div>
                                                    <br><br>
                                                    <label class="file-info">Upload Multiple Videos</label>
                                                    <input type="file" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="videos[]" id="videos" multiple>
                                                    ...
                                                    <div class="course-field mb--15">
                                                        ...
                                                        <div id="container2">
                                                            ...
                                                            <div class="field">
                                                                ...
                                                                <input type="file" id="document_file" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="document_file"
                                                        ...
                                                        <label for="">Upload Multiple Documents</label>
                                                        <input type="file" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="document_files[]" id="document_files" multiple>
                                                        {{-- <button class="btn btn-primary" id="add-field">+</button> --}}
                                                        {{-- <div class="row">
                                                            <div class="col-2">
                                                                <button type="button" class="sign"
                                                        ...
                                                        <label for="videoUrl">Upload PDF</label>
                                                            ...
                                                            <div id="container3">
                                                                ...
                                                                <div class="field">
                                                                    ...
                                                                    <input type="file" id="vocab_file" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="vocab_file" >

                                                                    <p class="file-info"></p>
                                                                </div>
                                                            </div>
                                                            <label for="">Upload Multiple Vocabulary PDF</label>
                                                            <input type="file" id="vocab_files" class="filepond bg-gray-50 border border-gray-300 text-gray-900 text-sm" name="vocab_files[]" multiple>
                                                            {{-- <div class="row">
                                                                <div class="col-2">
                                                                    <button type="button" class="sign"
                                                                        style="border: none;color: rgb(90, 88, 214);padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 10px;cursor: pointer;"
                                                ...
                                                <div id="quiz-container">
                                                    <div class="quiz-question rbt-single-quiz">
                                                        ...
                                                        <div class="question-options row g-3 mt--10">
                                                            ...
                                                            <div class="col-lg-6 rbt-modern-select bg-transparent">
                                                                <p class="rbt-checkbox-wrapper">
                                                                    Choose Correct Option

                                                                        <select name="coorect_answer" id="coorect_answer" class="form-control">
                ...
                $('#add-question-btn').click(function() {
                    ...
                    var newQuestion = $('<div class="quiz-question rbt-single-quiz">\
                        ...
                        questionCount + '-4" type="text" placeholder="Option four">\
                                        ...
                                        <p class="rbt-checkbox-wrapper">\
                                            Choose Correct Option\
                                            <select name="correct_answerq[]" class="form-control">\
                                                <option value="1">Option 1</option>\
                                                <option value="2">Option 2</option>\
                                                <option value="3">Option 3</option>\
                                                <option value="4">Option 4</option>\
        ...
        <script>
            ...
            //             if ($(this).val() === '') {
            //                 formIsValid = false;
            //                 $(this).siblings('.validation-text').show();

            //                 // firing popup for alert
            //                 Swal.fire({
            //                     // toast: true,
            //                     icon: 'error',

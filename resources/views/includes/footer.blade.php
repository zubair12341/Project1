        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
                    <p class="rbt-link-hover text-center text-lg-start">Copyright © 2023 <a href="https://themeforest.net/user/rbt-themes">DeveloperHubz.</a> All Rights Reserved</p>
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
...
<!-- Modal sign up start -->
 <!-- Modal -->
 <div class="modal fade signup-modal" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Create your account</h5> <button type="button"
                    ...
                    <div class="modal-body">
                        <div id="smartwizard" class="sw-main sw-theme-dots">
                            <ul class="nav nav-tabs step-anchor">
                                <li class="nav-item active"><a href="#step-1" class="nav-link">Step 1<br><small>Account
                                            Info</small></a></li>
                                <li class="nav-item"><a href="#step-2" class="nav-link">Step 2<br><small>Personal
                                            Info</small></a></li>
                                <li class="nav-item"><a href="#step-3" class="nav-link">Step 3<br><small>Payment
                                            Info</small></a></li>
                                <li class="nav-item"><a href="#step-4" class="nav-link">Step 4<br><small>Confirm
                                            details</small></a></li>
                                            <li class="nav-item"><a href="#step-5" class="nav-link">Step 4<br><small>Confirm
                                            details</small></a></li>
                            </ul>
                            <div class="sw-container tab-content" style="min-height: 0px;">
                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                             <div class="social-log">
                                                <i class="fa fa-facebook"></i> <span class="icon_title">Connect with Facebook</span>
                                             </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12">                    
                                                     <div class="social-log">
                                                <i class="fa fa-google-plus"></i> <span class="icon_title">Connect with Google</span>
                                             </div>
                                             <a href="#" class="stretched-link"> </a>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-md-12">                    
                                                        <div class="social-log" >
                                                             <i class="fa fa-envelope"></i> <span class="icon_title">Register</span>
                                             </div>
                                             <a href="#" class="stretched-link"> </a>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-12">   
                                        <input type="number" class="form-control" id="inputnumber" placeholder="Whatsapp (optional)">
                                        </div>
                                    </div>
                                </div>
                                <div id="step-5" class="tab-pane step-content">
                                   <div class="row">
                                        <div class="col-md-12">   
                                        <select id="inputbookgenre" class="form-control">
                                               <option selected>Books Genre</option>
                                              <option>legal fiction </option>
                                              <option>historical fiction </option>
                                              <option>war novel</option>
                                              ...
                                              <option>drama</option>
                                              <option>alternative history</option>
                                              <option>fairy tale</option>
                                              <option>biography</option>
                                              <option>thriller</option>
                                              <option>Southern Gothic</option>
                                              <option>Bildungsroman</option>
                                              <option>Epistolary novel</option>
                                              <option>realistic fiction</option>
                                              <option>Urban fantasy</option>
                                              <option>superhero fiction</option>
                                              <option>contemporary fantasy</option>
                                              <option>fable</option>
...
<!-- Modal sign up Login -->
 <!-- Modal -->
 <div class="modal fade signup-modal" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Login Now</h5> <button type="button"
                            class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
    ...
    <input type="password" id="password" name="password" class="form-control mt-4 mb-4" placeholder="Password" required="">
      <input type="submit" style="width: 100%;" class="login-sb mb-4" value="Log In">
    </form>

    <!-- Remind Passowrd -->
    <div id="formFooter mt-5">

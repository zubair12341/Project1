...
<!-- start-preloader -->
<div id="preloader" style="background: #fff;height: 100%;left: 0;opacity: 1;position: fixed;display: flex;align-items: center;justify-content: center; top: 0;width: 100%;z-index: 999999999;overflow-x: hidden !important;">
  <div class="preloader">
                                    ...
                                    <div class="rbt-header-top-news">
                                        <div class="inner">
                                            <div class="content">
                                                ...
                                                <span class="news-text"><img src="{{ asset('assets/images/icons/hand-emojji.svg')}}" alt="Hand Emojji Images"> Intro price. Get Wisdom Chest for Big Sale -95% off.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="rbt-dropdown-menu switcher-language">
                                        <li class="has-child-menu">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/Chinese-simplified.jpg')}}" alt="Language Images">
                                                        <span class="menu-item">Chinese simplified </span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/Chinese-traditional.jpg')}}" alt="Language Images">
                                                        <span class="menu-item">Chinese traditional</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/Japanese.jpg')}}" alt="Language Images">
                                                        <span class="menu-item">Japanese</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/Spanish.jpg')}}" alt="Language Images">
                                                        <span class="menu-item">Spanish</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/Korean.jpg')}}" alt="Language Images">
                                                        <span class="menu-item">Korean</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/Vietnamese.jpg')}}" alt="Language Images">
                                                        <span class="menu-item">Vietnamese</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/Russian.jpg')}}" alt="Language Images">
                                                        <span class="menu-item">Russian</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/Portuguese.jpg')}}" alt="Language Images">
                                                        <span class="menu-item">Portuguese</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/German.jpg')}}" alt="Language Images">
                                                        <span class="menu-item">German</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{ asset('assets/images/icons/French.jpg')}}" alt="Language Images">
            ...
            <div class="container-fluid">
                <div class="mainbar-row rbt-navigation-center align-items-center">
                    ...
                    <div class="rbt-main-navigation d-none d-xl-block">
                        ...
                        <a href="{{ route('books') }}">Books <i class="feather-chevron-down"></i></a>
                        <!-- Start Mega Menu  -->
                        <div class="rbt-megamenu grid-item-3">
                            <div class="wrapper">
                                <div class="row row--15">
                                    <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                                        <h3 class="rbt-short-title">Books Genre</h3>
                                        <ul class="mega-menu-item">
                                            <li><a href="#">legal fiction </a></li>
                                            <li><a href="#">historical fiction </a></li>
                                            <li><a href="#">war novel</a></li>
                                            <li><a href="#">science fiction</a></li>
                                            <li><a href="#">fantasy fiction</a></li>
                                            ...
                                            <li><a href="#">alternative history </a></li>
                                    ...
                                    <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                                        <ul class="mega-menu-item mt-5">
                                            ...
                                            <li><a href="#">Southern Gothic</a></li>
                                            <li><a href="#">Bildungsroman</a></li>
                                            <li><a href="#">Epistolary novel</a></li>
                                            <li><a href="#">realistic fiction</a></li>
                                            <li><a href="#">Urban fantasy</a></li>
                                            <li><a href="#">superhero fiction</a></li>
                                            <li><a href="#">contemporary fantasy</a></li>
                                            <li><a href="#">fable</a></li>
                                            <li><a href="#">historical drama</a></li>
                        ...
                        <!-- End Mega Menu  -->
                                ...
                                <li class="nav-link">
                                    <a href="{{ route('onlinecourse') }}">Online Courses
                                    </a>
                                </li>

                                <li class="nav-link">
                                    <a href="{{ route('contactus') }}">Contact Us </i></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="header-right">
                        ...
                        <div class="buttons">
                            <button type="button" class="btn btn-sign-login" data-toggle="modal" data-target="#loginModal">Login</button>
                               {{-- <button type="button" class="btn btn-sign-login ml-1" data-toggle="modal" data-target="#exampleModal">Sign Up</button> --}}
                               <a href="{{ url('register') }}"><button type="button" class="btn btn-sign-login ml-1">Sign Up</button></a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    <h5 class="rbt-card-title"><a href="course-details.html">Lorem</a>
                                    </h5>
    ...
    <div class="popup-mobile-menu">
        <div class="inner-wrapper">
            <div class="inner-top">
                ...
                <p class="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, sunt.</p>
                <ul class="navbar-top-left rbt-information-list justify-content-start">
                    <li>
                        <a href="mailto:hello@example.com"><i class="feather-mail"></i>example@gmail.com</a>
                    </li>
                    <li>
                        <a href="#"><i class="feather-phone"></i>0123-45677-12</a>
                    </li>
                </ul>
            </div>
            ...
            <nav class="mainmenu-nav">
                <ul class="mainmenu">
                    ...
                    <li class="nav-link with-megamenu has-menu-child-item position-static">
                        <a href="#">Books <i class="feather-chevron-down"></i></a>
                        <!-- Start Mega Menu  -->
                            ...
                            <div class="wrapper">
                                <div class="row row--15">
                                    <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                                        <h3 class="rbt-short-title">Books Genre</h3>
                                        <ul class="mega-menu-item">
                                            <li><a href="about-us-01.html">Fantasy</a></li>
                                            <li><a href="about-us-02.html">Science Fiction</a></li>
                                            <li><a href="event-grid.html">Dystopian</a></li>
                                            <li><a href="event-list.html">Action & Adventure</a></li>
                                            <li><a href="event-sidebar.html">Mystery</a></li>
                                            <li><a href="event-details.html">Horror</a></li>
                                            <li><a href="academy-gallery.html">Thriller & Suspense</a></li>
                                            <li><a href="admission-guide.html">Historical Fiction</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

     ...
     data-aos-anchor-placement="bottom-bottom">
                          ...
                          <div class="col-lg-3 col-sm-12">
                            <div class="rbt-form-group">
                                <input id="firstname" name="firstname" type="text" placeholder="Name">
                            </div>
                          </div>
                          <div class="col-lg-3 col-sm-12">
                            <div class="rbt-form-group">
                           ...
                           <div class="col-lg-3 col-sm-12">
                            <div class="rbt-form-group">
                                <button type="button" id="createbtn" class="rbt-btn btn-gradient">Create An Account</button>
                            </div>    
                        </div>
                        </div>
                      </form>
...
<script>
    ...
    // Add an event listener to the Create An Account button
    createAccountButton.addEventListener('click', function() {
        // Retrieve the name and email values
        const name = nameInput.value;
        const email = emailInput.value;

        // Construct the URL with query parameters
        const registrationURL = 'register?name=' + encodeURIComponent(name) + '&email=' + encodeURIComponent(email);

        // Redirect the user to the registration page with the query parameters
        ...
        <div class="row mb--60">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <span class="subtitle bg-secondary-opacity">{{ GoogleTranslate::trans('Introducing Our Top Sellers!', app()->getLocale())}}</span>
                    <h2 class="title">{{ GoogleTranslate::trans('Explore the Hottest Books in Demand', app()->getLocale())}}</h2>
                    <p class="description has-medium-font-size mt--20">{{ GoogleTranslate::trans('Ignite Your Imagination Today and Explore our Trending Books!', app()->getLocale())}}
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-12 col-xl-5">
                            <div class="inner">
                                <div class="rbt-category mb--20">
                                    <a href="#">{{ GoogleTranslate::trans('Introducing New Collection!', app()->getLocale())}}</a>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="inner">
                                ...
                                <div class="read-more-btn">
                                    <a class="rbt-btn rbt-switch-btn btn-gradient btn-sm" href="{{ url('register') }}">
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="inner pl--50 pl_sm--0 pl_md--0">
                        <div class="section-title text-start">
                            ...
                            <h2 class="title">Empowering a Community of Lifelong Learners</h2>
...
<div class="rbt-team-area bg_image--31">
    <div class="container">
        <div class="row mb--60">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h1 class="welcome">Instructor</h1>

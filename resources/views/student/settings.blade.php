...
@section('title', 'Wisdom Chest || Student Settings')
            ...
            <div class="tab-content">
                <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <form action="#" class="rbt-profile-row rbt-default-form row row--15">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="rbt-form-group">
                                <label for="skill">Book Subject</label>
                                <input id="skill" type="text" value="Subject">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="col-12">
                            <div class="rbt-form-group">
                                ...
                                <textarea id="bio" cols="20" rows="5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate quia quaerat qui ea, fugiat obcaecati.</textarea>
                            </div>
                        </div>
